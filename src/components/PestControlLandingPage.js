...
const PestControlLandingPage = () => {
  ...
  const internalLinks = [
    {
      ...
      links: [
        { label: "General Pest Control", href: "/general-pest-control" },
        {
          label: "Cockroach Control Service",
          href: "/cockroach-management-service",
        },
        { label: "Bed Bug Treatment", href: "/bed-bug-treatment" },
        { label: "Anti-Termite Treatment", href: "/anti-termite-treatment" },
        {
          label: "Post Construction Termite Treatment",
          href: "/post-construction-termite-treatment",
        },
        ...
        { label: "Rodent and Rat Control", href: "/rodent-management-service" },
        { label: "Ant Control Treatment", href: "/ant-control-treatment" },
        { label: "Wood Borer Treatment", href: "/wood-borer-treatment" },
      ],
    },
    {
      ...
      links: [
        ...
        { label: "Office Pest Control", href: "/office-pest-control" },
        {
          label: "Warehouse Pest Management",
          href: "/warehouse-pest-management",
        },
        ...
        { label: "Disinfection Services", href: "/disinfection-services" },
      ],
    },
    {
      category: "Explore Acuity",
      links: [
        { label: "View All Pest Control Services", href: "/services" },
        { label: "Pest Identification Guide", href: "/pest-identification" },
        { label: "Pest Control Blogs", href: "/blogs" },
        { label: "About Acuity Pest Control", href: "/about" },
        { label: "Contact Acuity Pest Control", href: "/contact" },
      ],
    },
  ];
  ...
  const relatedLinks = [
    ...
    { label: "View All Pest Control Blogs", href: "/blogs" },
  ];
  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="keywords"
          content="pest control services in Bangalore, pest control in Bangalore, pest control Bangalore, pest control near me, best pest control company in Bangalore, affordable pest control Bangalore, residential pest control Bangalore, commercial pest control Bangalore, cockroach control Bangalore, termite treatment Bangalore, bed bug treatment Bangalore, rodent control Bangalore, mosquito control Bangalore, office pest control Bangalore, warehouse pest control Bangalore"
        />
        <meta name="robots" content="index, follow" />
        <meta name="author" content="Acuity Pest Control Services" />
        ...
        <meta
          ...
          content="Pest control services in Bangalore by Acuity"
        />
        ...
        <link
          href="https://fonts.googleapis.com/css2?family=Oswald:wght@500;600;700&family=Inter:wght@400;500;600;700&family=IBM+Plex+Mono:wght@400;500&display=swap"
          rel="stylesheet"
        />
      </Helmet>
      ...
      <style>{`
        ...
        .hazard-stripes {
          background-image: repeating-linear-gradient(135deg, #E3A23E 0 18px, #12181A 18px 36px);
          background-size: 51px 51px;
        }
        .hazard-stripes-anim { animation: acuitySlide 6s linear infinite; }
        @keyframes acuitySlide { from { background-position: 0 0; } to { background-position: 51px 0; } }

        .ticket-edge {
          -webkit-mask-image:
            radial-gradient(circle 7px at 0 50%, transparent 7px, black 7.5px),
        ...
        .dot-grid {
          background-image: radial-gradient(circle, rgba(246,242,231,0.14) 1px, transparent 1px);
          background-size: 24px 24px;
        }

        .acuity-card-lift { transition: transform 0.35s cubic-bezier(0.16,1,0.3,1), box-shadow 0.35s ease, border-color 0.35s ease; }
        .acuity-card-lift:hover { transform: translateY(-6px); box-shadow: 0 20px 45px -18px rgba(18,24,26,0.35); }

        .acuity-pulse { animation: acuityPulse 2.2s ease-in-out infinite; }
        @keyframes acuityPulse {
          0%, 100% { box-shadow: 0 0 0 0 rgba(227,162,62,0.45); }
          50% { box-shadow: 0 0 0 10px rgba(227,162,62,0); }
        }

        .acuity-fab-pulse { animation: acuityFabPulse 2.4s ease-in-out infinite; }
        @keyframes acuityFabPulse {
          0%, 100% { box-shadow: 0 0 0 0 rgba(37,211,102,0.5); }
          50% { box-shadow: 0 0 0 14px rgba(37,211,102,0); }
        }

        .acuity-corner-tag { clip-path: polygon(0 0, 100% 0, 100% 70%, 50% 100%, 0 70%); }

        .acuity-underline-grow { position: relative; }
        .acuity-underline-grow::after {
          content: ""; position: absolute; left: 0; bottom: -6px; height: 3px; width: 42px;
          background: #E3A23E; border-radius: 999px;
        }
      ...
      <main className="font-body min-h-screen bg-[#F6F2E7] text-[#1C2321]">
        ...
        <section className="relative overflow-hidden bg-[#12181A]">
          ...
          />
          <div
            className="pointer-events-none absolute -bottom-32 -left-16 h-80 w-80 rounded-full opacity-20 blur-4xl"
            style={{
              background:
        ...
        <section
          id="services"
          className="bg-[#F6F2E7] px-4 py-16 sm:px-6 md:py-20 lg:px-8"
        >
                ...
                {pestsCovered.map((pest, index) => (
                  ...
                  >
                    <span className="font-mono text-[10px] font-bold opacity-50">
                      PEST-{String(index + 1).padStart(2, "0")}
                    </span>
        ...
        <div className="fixed bottom-0 left-0 right-0 z-50 grid grid-cols-2 border-t border-[#12181A]/10 bg-white p-2 shadow-2xl md:hidden">
          ...
          <a
            href={`https://wa.me/${phoneNumber}?text=${encodeURIComponent("Hello Acuity Pest Control, I need pest control service in Bangalore.")}`}
            target="_blank"
            rel="noreferrer"
